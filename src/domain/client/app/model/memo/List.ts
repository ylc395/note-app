import { last, zipObject, first } from 'lodash-es';
...
export default class ListView extends LoadableCollection<MemoVO> {
  ...
  protected queryItems(signal: AbortController['signal']): Promise<MemoVO[]>;
  protected queryItems(signal: AbortController['signal'], id: MemoVO['id']): Promise<MemoVO>;
  protected queryItems(signal: AbortController['signal'], id?: MemoVO['id']) {
    if (id) {
