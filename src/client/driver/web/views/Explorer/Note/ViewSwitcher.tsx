...
import Layout, { ExplorerTypes, NoteExplorerViews } from 'model/Layout';
import { action } from 'mobx';

const { useToken } = theme;
const switcher = [
  { key: NoteExplorerViews.Tree, title: '笔记树视图', icon: () => <ApartmentOutlined /> },
  { key: NoteExplorerViews.Custom, title: '自定义视图', icon: () => <ProfileOutlined /> },
] as const;
