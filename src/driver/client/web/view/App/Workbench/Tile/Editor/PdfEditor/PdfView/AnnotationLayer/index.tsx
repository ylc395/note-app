...
//       </Key>
//       <Show when={svgAnnotations().length > 0 || props.pdfViewer.editor.svgEditor.isEnabled}>
...
//           <Show
//             when={
//               props.pdfViewer.editor.svgEditor.isEnabled &&
//               props.pdfViewer.editor.svgEditor.mode === Mode.Draw &&
//               getSVGElement()
//             }
//           >
//             {(svg) => (
