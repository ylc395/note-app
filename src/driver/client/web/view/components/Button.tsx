...
const buttonVariants = cva(
  'flex items-center justify-center rounded cursor-pointer select-none transition-colors disabled:cursor-not-allowed',
  {
    variants: {
      intent: {
        primary:
          'bg-bg-accent text-fg-accent hover:not-disabled:bg-bg-accent-hover disabled:bg-bg-disabled disabled:text-fg-disabled',
        secondary:
          'text-fg-primary hover:not-disabled:bg-bg-hover active:not-disabled:bg-bg-active disabled:text-fg-disabled',
      },
      size: {
        lg: 'h-10 px-4 text-base [&>.lucide-icon]:size-6',
        'lg-square': 'size-10 text-base [&>.lucide-icon]:size-6',
        md: 'h-8 px-3 text-sm [&>.lucide-icon]:size-5 gap-1',
        'md-square': 'size-8 text-sm [&>.lucide-icon]:size-5',
        small: 'h-6 px-2 text-sm [&>.lucide-icon]:size-4 gap-1',
